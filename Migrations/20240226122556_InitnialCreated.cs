...
{
    /// <inheritdoc />
    public partial class InitnialCreated : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreFriend = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendRelation", x => new { x.User1ID, x.User2ID });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Location_LocationOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Post", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Post_AspNetUsers_ProfileOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photo_AspNetUsers_ProfileOwnerId",
                        column: x => x.ProfileOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Photo_Post_PostOwnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Video_AspNetUsers_ProfileOwnerId",
                        column: x => x.ProfileOwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Video_Post_PostOwnerId",
                        column: x => x.PostOwnerId,
                        principalTable: "Post",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_LocationOwnerId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Photo_PostOwnerId",
                table: "Photo",
                column: "PostOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Photo_ProfileOwnerId",
                table: "Photo",
                column: "ProfileOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Post_ProfileOwnerId",
                table: "Post",
                column: "ProfileOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Video_PostOwnerId",
                table: "Video",
                column: "PostOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Video_ProfileOwnerId",
                table: "Video",
                column: "ProfileOwnerId");
        }
